...
$title = _('Billing Journal Summary');
...
if (!isset($_POST['Show'])) {
    ...
    $cr=0;
			...
			if ($myrow['typeno']!=$LastJournal) {
			//echo '<td class="number"><a href="'.$rootpath.'/print/printJV.php?vouchNum='.$myrow['voucherno'].'&amp;Uname='.$Uname.'" target="blank">'._('Print') .'</a></td></tr>';
 ...
 $myUrl=$rootpath .'/print/printBillingJournal.php?uname='.$Uname;
