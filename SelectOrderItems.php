<?php
/* $Id: SelectOrderItems.php 5708 2012-10-13 03:26:00Z daintree $*/
...
echo '<a href="' . $rootpath . '/SelectsalesOrder.php">' . _('click here') . '</a> ';
...
echo '<a href="' . $rootpath . '/SelectSalesOrder.php">' . _('Process Unporcess Invoice') . '</a> ';
