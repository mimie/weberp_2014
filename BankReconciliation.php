...
/* $Id: BankReconciliation.php 5029 2012-03-06 00:44:02Z vvs2012 $*/
...
if (isset($_POST['BankAccount'])) {
	echo '<div class="centre">
			<p>
			<a tabindex="4" href="' . $rootpath . '/BankMatching.php?Type=Payments
													&amp;Balance='.$Balance.'
													&amp;TotalUnpresentedChecks='.$TotalUnpresentedCheques.'
													&amp;TotalUnclearedDeposits='.$TotalUnclearedDeposits.'
													&amp;Account='.$_POST['BankAccount'].
														'">' . _('Match off cleared payments') . '</a>
			</p>
			<br />

			<a tabindex="5" href="' . $rootpath . '/BankMatching.php?Type=Receipts
													&amp;Balance='.$Balance.'
                          &amp;TotalUnpresentedChecks='.$TotalUnpresentedCheques.'
                          &amp;TotalUnclearedDeposits='.$TotalUnclearedDeposits.'
													&amp;Account='.$_POST['BankAccount'].
														'">' . _('Match off cleared deposits') . '</a>
		</div>';
} else {
	echo '<div class="centre">
			<p>
