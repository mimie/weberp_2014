...
/* $Id: DeliveryDetails.php 5525 2012-07-21 23:37:38Z daintree $ */
...
echo '<p class="page_title_text"><img src="'.$rootpath.'/css/'.$theme.'/images/inventory.png" title="' . _('Delivery') . '" alt="" />' . ' ' . _('Confirm Customer Details') . '</p>';
...
if($_SESSION['Items'.$identifier]->DelAdd1=="")
	$myAdd="N/A";
else
	$myAdd=$_SESSION['Items'.$identifier]->DelAdd1;
...
echo '<tr>
	...
	<tr>
		...
		<td><input type="text" size="42" maxlength="40" name="BrAdd1" value="' . $myAdd . '" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="hidden" size="42" maxlength="40" name="BrAdd4" value="N/A" /></td>
	</tr>
	<tr>
