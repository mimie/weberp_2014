...
/* $Id: BankMatching.php 5623 2012-09-04 09:53:34Z tim_schofield $*/
...
if ($InputError !=1
	...
	echo '
				<table class="selection" border=1>
				<tr>
					<th colspan=2>Reconciliation Status</th>
				</tr>

				<tr>
          <th>Balance per Bank</th>
				...
				<tr>
          <th>Outstanding Check</th>
					<td><input class="number" 
											type="text" 
											name="OutstandingCheck" 
											size="15" 
											maxlength="15"
											value="'.$_GET['TotalUnpresentedChecks'].'"
							></input></td>
        </tr>
          ...
          <th>Deposit in Transit</th>
        	<td><input class="number" 
											...
											size="15" 
											maxlength="15"
											value="'.$_GET['TotalUnclearedDeposits'].'"
							></input></td>
				</tr>
          ...
          <th>GL Balance</th>
				...
				<tr>
          <th><b>Unrecon</b></th>
					<td><input class="number" type="text" name="Unrecon" size="15" maxlength="15"></input></td>
        </tr>
