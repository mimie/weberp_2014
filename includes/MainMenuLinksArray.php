...
$MenuItems['AR']['Transactions']['Caption'] = array (_('Select Order to Invoice'),
														...
														_('CiviCRM billing posted (WebErp)')
													);

																									//SelectsalesOrder.php-SelectOrderItems
$MenuItems['AR']['Transactions']['URL'] = array ('/SelectOrderItems.php',
...
$MenuItems['stock']['Transactions']['URL'] = array ('/PO_Header.php?NewOrder=Yes',
...
//Dito po ako nagbago
//CustomerReciept saka SelectSupplier


$MenuItems['GL']['Transactions']['URL'] = array ('/SelectSupplierPay.php',
													'/CustomerReceipt.php?NewReceipt=Yes&amp;Type=Customer',
...
$MenuItems['GL']['Reports']['Caption'] = array (_('Trial Balance'),
												...
												_('Journal Voucher\Entry Transaction Report'),
												_('Billing Journal Summary'),
												_('Billing Register'),
												_('Cash Receipts Journal Summary'),
												_('Cash Payment Journal Summary'),
												_('Daily Collection Turnover'),
...
$MenuItems['GL']['Reports']['URL'] = array ('/TBalance.php',
											...
											'/GLBillingSummary.php',
											'/GLBillingRegister.php',
											'/GLReceiptJournal.php',
											'/GLPaymentJournal.php',
											'/DCT.php',			
...
$MenuItems['GL']['Maintenance']['Caption'] = array (_('GL Account'),
													...
													_('Account Sections'),
													_('GL Tags'),
													_('Reprint Check Voucher'),
													_('GL Account Code Segment 3'),
													_('GL Tag ID Segment 1')
													);
