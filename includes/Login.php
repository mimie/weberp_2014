...
<head>
	...
	<link rel="stylesheet" href="css/fluid/login.css" type="text/css" />
</head>
<body>
...
<div id="container">
	...
	<br />
	<span><b><?php echo _('User name'); ?></b>:</span><br />
	<input type="text" style="text-align: center;" name="UserNameEntryField" maxlength="20" /><br />
	<span><b><?php echo _('Password'); ?>:</b></span><br />
	...
	<br>
	<br>
	<div style="text-align:center"><font size="1"><b>webERP</b> design for <br>Institute of International Auditors Philippines
					<br>Design by: Imperium INC.</div>
</div>
